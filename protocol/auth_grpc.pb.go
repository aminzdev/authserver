...
const (
	...
	Auth_ValidateSession_FullMethodName = "/protocol.Auth/ValidateSession"
)
...
func (c *authClient) ValidateSession(ctx context.Context, in *ValidateSessionReq, opts ...grpc.CallOption) (*ValidateSessionRes, error) {
...
func (UnimplementedAuthServer) ValidateSession(context.Context, *ValidateSessionReq) (*ValidateSessionRes, error) {
...
func _Auth_ValidateSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).ValidateSession(ctx, req.(*ValidateSessionReq))
	}
	return interceptor(ctx, in, info, handler)
}
